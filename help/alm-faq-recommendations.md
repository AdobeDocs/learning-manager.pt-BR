...
Consulte [Adobe Learning Manager- Manual do desenvolvedor de aplicativos](https://experienceleague.adobe.com/pt-br/docs/learning-manager/using/integration/developer-manual) para obter mais informações.
