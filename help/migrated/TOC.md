---
user-guide-title: Guia do Adobe Learning Manager
...
* Introdução {#introduction}
   ...
   * [Recommendations no Adobe Learning Manager](recommendations-adobe-learning-manager.md)
...
* Começar {#get-started}
   ...
   * [Começar como aluno](learners/feature-summary/getting-started-learner.md)
...
* Administrador {#admin}
   ...
   * [Adicionar usuários e criar grupos de usuários](administrators/feature-summary/add-users-user-groups.md)
   ...
   * [Iniciando como administrador](administrators/feature-summary/getting-started.md)
   ...
   * [Extensão nativa](administrators/feature-summary/native-extensibility.md)
...
* Administrador de integração {#integration}
   ...
   * [Gerenciar funções personalizadas por meio de arquivos CSV](integration-admin/feature-summary/configure-role-csv-files.md)
* Autores {#authors}
   ...
   * [Integração com o Adobe Connect](authors/feature-summary/adobeconnect-integration.md)
   * [Adicionar objetos de aprendizado em diferentes locais](authors/feature-summary/add-new-language-learning-objects.md)
...
* Professor {#instructor}
   ...
   * [Gerenciar alunos para a sua sessão](instructors/feature-summary/learners.md)
* Aluno {#learner}
   * [Fazer logon](learners/feature-summary/user-login.md)
   ...
   * [Integração com o Adobe Connect](learners/feature-summary/adobeconnect-integration.md)
   ...
   * [aplicativo de desktop Adobe Learning Manager](learners/adobe-learning-manager-app-for-desktop.md)
   ...
   * [Requisitos de sistema | aplicativo de desktop Adobe Learning Manager](learners/adobe-learning-manager-app-for-desktop/adobe-learning-manager-desktop-app-system-requirements.md)
* Gerente {#manager}
   ...
   * [Notificações do usuário](managers/feature-summary/user-notifications.md)
...
* Base de conhecimento {#knowledge-base}
   ...
   * [Publicar questões no domínio da UE](kb/publish-issue-eu-domain.md)
   * [Não é possível registrar-se como usuário externo](kb/register-issue-external-user.md)
   * [Integração do Okta Ative Diretory com o Adobe Learning Manager](kb/okta-active-directory-integration.md)
