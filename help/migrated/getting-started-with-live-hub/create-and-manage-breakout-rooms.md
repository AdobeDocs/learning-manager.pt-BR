...
1. Selecione ![ícone de breakout](./assets/breakout-icon.svg) na barra de controle.

   ![Selecionar o painel de sessões de sessão de grupo](assets/select-breakout-sessions-panel.png)
...
1. Selecione ![ícone de breakout](./assets/breakout-icon.svg) na barra de controle. <br> O painel Debates é aberto.

   ![Abrir Painel de Debates](assets/open-breakouts-panel.png)
...
1. Selecione **Salvar**. <br> A sessão de breakout aparece no painel **Breakouts** com uma tag **New**.
...
1. Selecione **Iniciar breakouts**. <br> Uma notificação mostra **Começando em 5 segundos**, e os alunos são movidos para suas salas de sessão de grupo atribuídas com a configuração aplicada.

   ![Iniciar Sessão de Saída](assets/start-breakout-session.png)
...
1. Selecione o ícone de edição (lápis) na sessão.
   ...
   ![Editar Ícone de Sessão de Grupo](assets/edit-breakout-session-icon.png)
...
1. Selecione as mais opções (**...**) na sessão.
   ...
   ![Duplicar Menu de Sessão de Sessão de Grupo](assets/duplicate-breakout-session-menu.png)
...
1. Selecione **Excluir**. <br> Uma janela pop-up de confirmação é exibida.

   ![Excluir Confirmação de Saída](assets/delete-breakout-confirmation.png)
...
1. Selecione **Verificar Sala**. <br> Uma janela pop-up **Verificar sala** é exibida com o resumo da sala.

   ![Resumo de IA da Sala de Sessão de Grupo](assets/breakout-room-ai-summary.png)
...
![Painel de Bate-papo da Sala de Sessão de Grupo](assets/breakout-room-chat-panel.png "Interface da sessão de grupo mostrando o painel de bate-papo na sala de grupo.")
...
1. Selecione **Encerrar detalhamentos** na sessão de detalhamento ativa. <br> Todos os alunos são movidos de volta para a sala principal e a sessão de grupo termina para todos os participantes.

   ![Encerrar Sessão de Saída](assets/end-breakout-session.png)
