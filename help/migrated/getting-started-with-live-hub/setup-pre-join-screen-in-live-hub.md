...
![Permitir Prompt de Permissões do Navegador](assets/allow-browser-permissions-prompt.png)
...
1. Selecione o **Microfone** na tela de pré-ingresso. A lista suspensa **Microfone** é exibida.
   ...
   ![Visualização Suspensa Do Microfone](assets/microphone-dropdown-preview.png)
...
1. Selecione o menu suspenso **Câmera**. O menu suspenso **Câmera** é exibido.
   ...
   ![Menu Suspenso de Fundo da Câmera](assets/camera-background-dropdown.png)
