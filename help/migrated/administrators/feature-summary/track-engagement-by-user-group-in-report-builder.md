...
2. Selecione **Criar relatório**. Digite um nome, por exemplo, Compromisso por grupo de usuários MoM.
...
5. Selecione **+** próximo a **Tempo Gasto**. Selecione o ícone de **editar** (lápis) e insira o tempo total gasto do alias.
6. Expanda o **Objeto de Aprendizado** e selecione **+** ao lado da **Contagem de Usuários de Inscrição**. Selecione o ícone **editar** e insira o alias Total de inscrições.
7. Selecione **Agrupar por: selecione** na parte superior do painel **Colunas Selecionadas**.
8. Escolha **Inscrição - Data de Inscrição** e defina a granularidade como **Mês**. Escolha **Grupo de Usuários do Campo Ativo - Nome do Grupo de Usuários**. Ambos aparecem como etiquetas: Inscrição - Data de Inscrição (Mês) e Grupo de Usuários do Campo Ativo - Nome do Grupo de Usuários.
...
11. Selecione **Adicionar filtro**. Escolha **Inscrição - Data de Inscrição**, selecione um intervalo relativo como **Últimos 3 meses** ou insira um intervalo de datas específico.
