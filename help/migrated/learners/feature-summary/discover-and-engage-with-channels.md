...
1. Selecione **Canais** na barra de navegação superior.
   ...
   ![Guia Todas as Páginas de Canais](assets/channels-page-all-tab.png)
...
1. Selecione o botão **Assinar**.
   ...
   <br> O canal é adicionado à guia **Inscrito**.

1. Selecione a guia **Inscrito**.

   <br> Isso exibe todos os canais nos quais você se inscreveu.

   ![Lista de Canais Inscritos](assets/subscribed-channels-list.png)
...
![Guia Vídeos Curtidos](assets/liked-videos-tab.png)
...
1. Selecione **Publicação**.
   ...
   <br> O comentário é adicionado ao thread de discussão e fica visível para outros alunos que visualizarem o vídeo.

   ![Discussão em Vídeo do Canal](assets/channel-video-discussion.png)
